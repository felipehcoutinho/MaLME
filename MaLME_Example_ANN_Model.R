...
example_df<-read.table(file="/home/felipe.coutinho/MaLME/Example_Datasets/Example_ANN_Input_Data_2_Prok.tsv",sep="\t",header=TRUE,quote="",comment="",stringsAsFactors=TRUE,row.names=1)
